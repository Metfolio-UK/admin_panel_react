          ...
          <div style={cssStyle.container}>
            <Row style={cssStyle.headerRow}>
                ...
                <Col style={cssStyle.headerIcon}>
                    ...
                    <div style={cssStyle.navyText}>Entry #{props.data.entry_id}</div>
                </Col>
            ...
            <Row style={cssStyle.nameRow}>
                ...
                <div style={cssStyle.navyText}>Entered By</div>
                </Col>
                <Row>
                    ...
                    <Col style={cssStyle.nameCol}>
                        ...
                        <div style={cssStyle.fadedText}>{props.data.user_type}</div>
            ...
            <div className='btn' style={cssStyle.downloadButton}>Download Invoice</div>   
          </div>
        </PopupModal>
