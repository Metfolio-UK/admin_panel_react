...
const SellOrderChart = ({ chartColor, chartHeight}) => {
  ...
  const cssStyle = {
    ...
    header:{
        ...
        padding:'32px',
        justifyContent:'space-between',
        backgroundColor: sellOrderChartColor,
  ...
  return (
    <div >
      <Row style={cssStyle.header}>
        <Col>
            <div style={cssStyle.WhiteHeadText}>Sell Orders</div>
      ...
      <div>
        ...
        <Col style={cssStyle.whiteContainer}>
            <Row style={{display:'flex', flexDirection:'row', justifyContent:'space-between', flexGrow:1}}>
                <Col>
                    <div style={{...cssStyle.fadedText, textAlign:'left'}}>Total Sell Orders</div>
                    <div style={{...cssStyle.navyText, textAlign:'left'}}>£34,000</div>
                </Col>
                <Col>
  ...
  return {
    ...
    chart: {
        events: {
          ...
          background: sellOrderChartColor,
      fontFamily: 'Poppins',
      type: 'area',
      height: chartHeight,
      toolbar: {
