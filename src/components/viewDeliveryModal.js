          ...
          <div style={cssStyle.container}>
            <Row style={cssStyle.headerRow}>
                ...
                <Col style={cssStyle.headerIcon}>
                    ...
                    <div style={cssStyle.navyText}>Delivery #{props.data.order_id}</div>
                </Col>
            ...
            <Row style={cssStyle.contentRow}>
                ...
                <div style={{...cssStyle.navyText, textAlign:'right'}}>
                    <div>{props.data.row5right}</div>
                    <div>{props.data.row6right}</div>
                    <div>{props.data.row7right}</div>
                    <div>{props.data.row8right}</div>
                </div>
            </Row>
