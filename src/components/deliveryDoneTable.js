...
const DeliveryDoneTable = ({className, tableData}) => {
    ...
    <div className={`card ${className}`} >
      ...
      <div style={cssStyle.cardpadding} className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span style={{fontSize:'18px',fontWeight:'500',lineHeight:'21px'}}>Deliveries (Done)</span>
          <span className='mt-1 fw-semibold fs-7' style={cssStyle.greyColor} >20 Deliveries Completed</span>
        </h3>
...
export default DeliveryDoneTable
